...
## PROCESADO MENSAJES ##
def generar_mensajes(mensajes, campo, ruta, id_asig):
    ...
    for index, mensaje in enumerate(mensajes):
        ...
        if terminal == -1:
            ...
            try:
                ...
                max_tiempos = max(contador_tiempos_previos_ph)
                min_tiempos = min(contador_tiempos_previos_ph)
...
## PROCESADO USUARIOS ##
def generar_autores(mensajes, hilos, campo):
    global usuarios
...
def generar_asignaturas(mensajes, hilos, campo):
    global asignaturas
...
## PROCESADO FOROS ##
def generar_foros(mensajes, hilos, campo):
    global foros
