            ...
            if linea.startswith('Foro: '):
                ...
                if autor:
                    ...
                    mensaje = {'Foro': id_foro, 'ForoN': nombreForo, 'Caracteres foro': len(nombreForo),
                               ...
                               'Inicial': inicial, 'Contestación': respuesta, 'Terminal': terminal,# cuando un menssaje es Iniciador el anterior es Terminal
                               'Remitente': id_autor, 'Autor': autor, 'Día': dia_semana, 'Fecha': fecha, 'Hora': hora, 'Date': fecha + ' ' + hora,
                               'Título mensaje': tit_mensaje, 'Caracteres título': len(tit_mensaje),
                               'Texto mensaje': texto.strip(), 'Caracteres mensaje': len(texto), 'adjunto': '[IMAGE:.*]'}
